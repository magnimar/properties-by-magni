...
def send_verification_email(to_email, verification_token):
    ...
    content = f"""
        <h2 style="color: #1e293b; margin-top: 0;">Welcome to Properties by Magni!</h2>
    ...
    """
    html_content = get_email_template(content, "Virkja aðgang - Properties by Magni")
...
def send_password_reset_email(to_email, reset_token):
    ...
    """
    html_content = get_email_template(content, "Endurstilla lykilorð - Properties by Magni")
