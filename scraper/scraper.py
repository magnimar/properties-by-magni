...
class Scraper:
    ...
    def _get_location_names(zip_code: str) -> tuple[str, str]:
        ...
        locations = {
            ...
            "191": ("Vogar", "Vogum"),
            "300": ("Akranes", "Akranesi"), "301": ("Akranes", "Akranesi"),
            "310": ("Borgarnes", "Borgarnesi"), "311": ("Borgarnes", "Borgarnesi"),
            "320": ("Reykholt", "Reykholti"), "340": ("Stykkishólmur", "Stykkishólmi"),
            "345": ("Flatey", "Flatey"), "350": ("Grundarfjörður", "Grundarfirði"),
            "355": ("Ólafsvík", "Ólafsvík"), "356": ("Snæfellsbær", "Snæfellsbæ"),
            "360": ("Hellissandur", "Hellissandi"), "370": ("Búðardalur", "Búðardal"),
            "371": ("Búðardalur", "Búðardal"), "380": ("Reykhólahreppur", "Reykhólahreppi"),
            "400": ("Ísafjörður", "Ísafirði"), "401": ("Ísafjörður", "Ísafirði"),
            "410": ("Hnífsdalur", "Hnífsdal"), "415": ("Bolungarvík", "Bolungarvík"),
            "416": ("Bolungarvík", "Bolungarvík"), "420": ("Súðavík", "Súðavík"),
            "421": ("Súðavík", "Súðavík"), "425": ("Flateyri", "Flateyri"),
            "426": ("Flateyri", "Flateyri"), "430": ("Suðureyri", "Suðureyri"),
            "431": ("Suðureyri", "Suðureyri"), "450": ("Patreksfjörður", "Patreksfirði"),
            "451": ("Patreksfjörður", "Patreksfirði"), "460": ("Tálknafjörður", "Tálknafirði"),
            "461": ("Tálknafjörður", "Tálknafirði"), "465": ("Bíldudalur", "Bíldudal"),
            "466": ("Bíldudalur", "Bíldudal"), "470": ("Þingeyri", "Þingeyri"),
            "471": ("Þingeyri", "Þingeyri"),
            "500": ("Staður", "Stað"), "510": ("Hólmavík", "Hólmavík"),
            "511": ("Hólmavík", "Hólmavík"), "512": ("Hólmavík", "Hólmavík"),
            "520": ("Drangsnes", "Drangsnesi"), "522": ("Kjörvogur", "Kjörvogi"),
            "523": ("Bær", "Bæ"), "524": ("Norðurfjörður", "Norðurfirði"),
            "530": ("Hvammstangi", "Hvammstanga"), "531": ("Hvammstangi", "Hvammstanga"),
            "540": ("Blönduós", "Blönduósi"), "541": ("Blönduós", "Blönduósi"),
            "545": ("Skagaströnd", "Skagaströnd"), "546": ("Skagaströnd", "Skagaströnd"),
            "550": ("Sauðárkrókur", "Sauðárkróki"), "551": ("Sauðárkrókur", "Sauðárkróki"),
            "560": ("Varmahlíð", "Varmahlíð"), "561": ("Varmahlíð", "Varmahlíð"),
            "565": ("Hofsós", "Hofsósi"), "566": ("Hofsós", "Hofsósi"),
            "570": ("Fljót", "Fljótum"), "580": ("Siglufjörður", "Siglufirði"),
            "581": ("Siglufjörður", "Siglufirði"), "600": ("Akureyri", "Akureyri"),
            "601": ("Akureyri", "Akureyri"), "602": ("Akureyri", "Akureyri"),
            "603": ("Akureyri", "Akureyri"), "604": ("Akureyri", "Akureyri"),
            "605": ("Akureyri", "Akureyri"), "606": ("Akureyri", "Akureyri"),
            "607": ("Akureyri", "Akureyri"), "610": ("Árskógssandur", "Árskógssandi"),
            "611": ("Grímsey", "Grímsey"), "616": ("Grenivík", "Grenivík"),
            "620": ("Dalvík", "Dalvík"), "621": ("Dalvík", "Dalvík"),
            "625": ("Ólafsfjörður", "Ólafsfirði"), "626": ("Ólafsfjörður", "Ólafsfirði"),
            "630": ("Hrísey", "Hrísey"), "640": ("Húsavík", "Húsavík"),
            "641": ("Húsavík", "Húsavík"), "645": ("Fosshóll", "Fosshóli"),
            "650": ("Laugar", "Laugum"), "660": ("Mývatn", "Mývatni"),
            "670": ("Kópasker", "Kópaskeri"), "671": ("Kópasker", "Kópaskeri"),
            "675": ("Raufarhöfn", "Raufarhöfn"), "680": ("Þórshöfn", "Þórshöfn"),
            "681": ("Þórshöfn", "Þórshöfn"),
            "700": ("Egilsstaðir", "Egilsstöðum"), "701": ("Egilsstaðir", "Egilsstöðum"),
            "710": ("Seyðisfjörður", "Seyðisfirði"), "715": ("Mjóifjörður", "Mjóafirði"),
            "720": ("Borgarfjörður eystri", "Borgarfirði eystra"), "730": ("Reyðarfjörður", "Reyðarfirði"),
            "735": ("Eskifjörður", "Eskifirði"), "740": ("Neskaupstaður", "Neskaupstað"),
            "750": ("Fáskrúðsfjörður", "Fáskrúðsfirði"), "755": ("Stöðvarfjörður", "Stöðvarfirði"),
            "760": ("Breiðdalsvík", "Breiðdalsvík"), "765": ("Djúpivogur", "Djúpavogi"),
            "780": ("Höfn í Hornafirði", "Höfn í Hornafirði"), "781": ("Höfn í Hornafirði", "Höfn í Hornafirði"),
            "785": ("Öræfi", "Öræfum"),
